...
exports.LegendView = (function (superClass) {
    ...
    LegendView.prototype.compute_legend_bbox = function () {
        var ctx, glyph_height, glyph_width, h_range, j, label_height, label_standoff, label_width, legend_height, legend_margin, legend_names, legend_padding, legend_spacing, legend_width, len, location, max_label_width, name, panel, ref, ref1, ref2, v_range, width, x, y;
        ...
        this.text_widths = {};
        for (j = 0, len = legend_names.length; j < len; j++) {
            name = legend_names[j];
    ...
    LegendView.prototype.on_hit = function (sx, sy) {
        var bbox, field, glyph_height, glyph_width, h, item, j, k, l, label, label_standoff, labels, legend_bbox, legend_spacing, len, len1, len2, len3, m, r, ref, ref1, ref2, ref3, ref4, vertical, w, x1, x2, xoffset, y1, y2, yoffset;
        glyph_height = this.model.glyph_height;
        glyph_width = this.model.glyph_width;
        legend_spacing = this.model.spacing;
        label_standoff = this.model.label_standoff;
    ...
    LegendView.prototype._draw_legend_items = function (ctx, bbox) {
        var active, field, glyph_height, glyph_width, h, i, item, j, k, l, label, label_standoff, labels, legend_item, legend_spacing, len, len1, len2, r, ref, ref1, ref2, ref3, vertical, view, w, x1, x2, xoffset, y1, y2, yoffset;
        glyph_height = this.model.glyph_height;
        glyph_width = this.model.glyph_width;
        legend_spacing = this.model.spacing;
        label_standoff = this.model.label_standoff;
        ...
        for (j = 0, len = ref.length; j < len; j++) {
            ...
            for (k = 0, len1 = labels.length; k < len1; k++) {
                ...
                if (i === 0) {
                    legend_item.label = {
                        text: label,
                        bbox: {
                            x: Math.round(x2 + this.model.label_standoff),
                            y: Math.round(y1),
                            w: Math.round(this.text_widths[label]),
                            h: Math.round(this.max_label_height)
                        }
                    };
                    legend_item.preview = {
                        bbox: {
            ...
            this.data.items.push(legend_item);
        }
        return null;
    };
...
exports.Legend = (function (superClass) {
    ...
    Legend.prototype.get_legend_names = function () {
        var item, j, labels, legend_names, len, ref;
        legend_names = [];
        ref = this.items;
        for (j = 0, len = ref.length; j < len; j++) {
            item = ref[j];

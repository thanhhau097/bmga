...
export var GridView = (function(superClass) {
  ...
  GridView.prototype._draw_grid_helper = function(ctx, props, xs, ys) {
    var bbox, bboxOffset, endX, endY, gridlines, i, j, k, l, ref, ref1, ref2, sx, sy, temp;
    props.set_value(ctx);
    bboxOffset = 2;
    gridlines = [];
    for (i = k = 0, ref = xs.length; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
      ...
      for (j = l = 1, ref2 = sx.length; 1 <= ref2 ? l < ref2 : l > ref2; j = 1 <= ref2 ? ++l : --l) {
...
export var Grid = (function(superClass) {
